                                    ...
                                    <div class="row">
                                        <div className='col-md-6'>
                                            <div class="">
                                                ...
                                                <select class="form-select" aria-label="Default select example" onChange={handleInputChange} name="job_type" value={jobPost.job_type}>
                                        ...
                                        <div className='col-md-6'>
                                            <div class="">
                                                ...
                                                <select class="form-select" aria-label="Default select example"  onChange={handleInputChange} name="department_id" value={jobPost.department_id}>
                                                    <option selected>Select</option>
                                                    {
                                    ...
                                    <div className='row mt-2'>
                                        <div className='col-md-6'>
                                            <div class="">
                                                ...
                                                <select class="form-select" aria-label="Default select example" onChange={handleInputChange} name="job_location" value={jobPost.job_location}>
                                                    <option selected>Select</option>
                                        ...
                                        <div className='col-md-6'>
                                            <div class="mt-1">
                                                ...
                                                <input type="text" class="form-control" id="exampleFormControlInput1" onChange={handleInputChange} name="job_title" value={jobPost.job_title}/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='row mt-2'>
                                        <div className='col-md-6'>
                                            <div class="mt-1">
                                                ...
                                                <input type="text" class="form-control" id="exampleFormControlInput1" onChange={handleInputChange} name="company_name" value={jobPost.company_name} />
                                            </div>
                                        </div>
                                        <div className='col-md-6'>
                                            <div class="mt-1">
