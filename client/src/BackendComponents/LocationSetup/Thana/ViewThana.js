...
function ViewThana() {
                                    ...
                                    onClick={(e) => {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                axios.delete(`/api/thana/${row.id}`).then(res => {
                                                    if (res.data.status === 200) {
    ...
    const handleSearch = debounce((searchText) => {
        const result = allThana.filter(item =>
          item.thana_name.toLowerCase().includes(searchText)
        );
        if(searchText!==''){
            setallThana(result);
                            ...
                            <div className="col-md-12 mt-3">
                                ...
                                <div className="card bg-white">
                                    ...
                                    <div className='card-body '>
                                        ...
                                        <div className="d-flex justify-content-between">
                                            <div>
                                            <h6 className="">ALL Thana Name</h6>

                                            </div>
                                            <div>
                                            <button className="btn btn-success btn-sm float-end">
                                                 <Link to="/create-thana" className="text-decoration-none text-white">  Add Thana</Link>
                                                 </button>
