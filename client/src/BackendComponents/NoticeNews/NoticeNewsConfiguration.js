...
function NoticeNewsConfiguration() {
    ...
    const handleCategorySave = (e) => {
        ...
        axios.post(`/api/add-notice-news-category`, addCategory).then(res => {
    ...
    const handleCategoryUpdate = (e) => {
        ...
        axios.post(`/api/update-notice-news-category/${editCategoryId}`, editJob).then(res => {
            if (res.data.status == 200) {
                Swal.fire(res.data.message, '', 'success')
                setRenderAllCategory(res.data);
    ...
    const deleteCategory = (e, id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`/api/delete-notice-news-category/${id}`).then(res => {
                    if (res.data.status === 200) {
                        setRenderAllCategory(res.data);
                    }
                });
    ...
    useEffect(() => {
        ...
        axios.get(`/api/edit-notice-news-category/${editCategoryId}`).then(res => {
            if (res.data.status == 200) {
        ...
        axios.get(`/api/edit-notice-news-subcategory/${editSubCategoryId}`).then(res => {
            if (res.data.status == 200) {
    ...
    const handleSubCategorySave = (e) => {
        ...
        //     created_by: '',
        // }
        axios.post(`/api/add-notice-news-subcategory`, addSubCategoryState).then(res => {
            if (res.data.status == 200) {
                Swal.fire(res.data.message, '', 'success')
    ...
    const handleEditSubCategoryUpdate = (e) => {
        ...
        axios.post(`/api/update-notice-news-subcategory/${editSubCategoryId}`, editSubCategoryData).then(res => {
            if (res.data.status == 200) {
                Swal.fire(res.data.message, '', 'success')
                setRenderAllSubCategory(res.data);
    ...
    const deleteSubCategory = (e, id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`/api/delete-notice-news-subcategory/${id}`).then(res => {
                    if (res.data.status === 200) {
...
export default NoticeNewsConfiguration