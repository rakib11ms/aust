...
function CreateOrganization() {
    ...
    const submitPost = (e) => {
        ...
        axios.post(`/api/add-organization-setup`, formData).then(res => {
                        ...
                        <div className='create-job-wrapper mt-2'>
                            <div className='card mt-3'>
                                <div className='card-header d-flex align-items-center justify-content-between'>
                                    <h5>Create Organization/Insitute</h5>
                                ...
                                <div className='card-body px-4'>
                                    <form>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" className='btn btn-success rounded-3' onClick={submitPost}>SAVE</button>
                                        </div>
                                    </form>
